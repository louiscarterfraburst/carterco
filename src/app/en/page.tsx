...
export default function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col bg-[#0f0d0a] text-[var(--cream)]">
      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-1 flex-col items-center justify-center px-8 pt-16 text-center sm:px-12 sm:pt-20">
      ...
      {/* Section removed 2026-05-18:
          · "Du beholder alt du har." integration-scatter section dropped.
          · Sand-bridge that preceded it dropped (was there to break the
            ember-to-ember run between journey and integration; with
            integration gone, journey now flows directly into the sand
            founder section, which is a natural transition).
        ...
        <div className="relative z-[1] mx-auto grid w-full max-w-[1400px] gap-12 px-8 sm:px-12 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:items-center lg:gap-16">
          <div className="min-w-0">
            ...
            <div className="mt-8">
              ...
              >
                Find me my leads <span aria-hidden>→</span>
              </button>
            </div>
          </div>
          ...
          <div className="min-w-0">
            <div className="overflow-hidden rounded-2xl border border-[#29261f]/25 bg-[#14110d] shadow-[0_40px_90px_-30px_rgba(20,17,13,0.6)]">
              ...
              <div className="hidden grid-cols-[minmax(0,5fr)_minmax(0,4fr)_minmax(0,7fr)] gap-4 border-b border-[var(--cream)]/[0.07] px-5 py-2 sm:grid">
                <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-[var(--cream)]/35">Company</span>
                <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-[var(--cream)]/35">Contact</span>
                <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-[var(--cream)]/35">Why now</span>
              </div>
