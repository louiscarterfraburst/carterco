      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-1 flex-col items-center justify-start px-8 pt-[12vh] text-center sm:px-12 sm:justify-center sm:pt-20">
        ...
        <div className="mt-10 flex flex-col gap-14 pb-10 sm:mt-12 lg:mt-14">
          ...
          <div className="flex flex-col items-center gap-4">
            <p className="max-w-lg text-pretty text-[16px] leading-relaxed text-[var(--cream)]/85">
              {/* NBSP før "Gratis." — må aldrig stå alene som orphan-linje på mobil */}
            ...
            <div className="relative z-[1] grid items-start gap-10 sm:gap-12 lg:grid-cols-[3fr_2fr] lg:gap-8">
              ...
              <div>
                ...
                <div className="mt-8 space-y-3 text-[15px] leading-[1.6] text-[#29261f]/85 sm:mt-10 sm:text-[16px]">
                  ...
                  <p>
                    Vil du se det med jeres egne købere?
                  </p>
                  <div className="pt-2">
                    <button
                      type="button"
