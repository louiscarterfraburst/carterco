...
//
// As of 2026-05-22 (Phase 1 SMS rebuild) we no longer auto-fire a
// "hvem er det?" SMS on short recordings — that was reckless. Follow-up
// SMS, if any, is now operator-triggered from /leads.
