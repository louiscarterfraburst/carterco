// OdaGroup agent brief — canonical source: clients/odagroup/agent-brief.md
// This is the runtime mirror (edge functions bundle, so the brief is inlined).
// Owns ONLY OdaGroup. Do not add other clients' content to this file.

export const ODAGROUP_AGENT_BRIEF = String.raw`
## 1. The core idea
...
// Strategy keys this brief constrains its AI to. The validator checks the
// model's chosen strategy against THIS set, not a cross-client union.
export const ODAGROUP_STRATEGIES = [
