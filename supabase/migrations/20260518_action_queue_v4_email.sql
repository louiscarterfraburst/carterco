-- vw_action_queue v4 — adds 'email' kind for accepted leads with an enriched
-- email that haven't been emailed yet. Joins outreach_emails (latest per lead)
-- to show the draft subject in the snippet and hide rows where sent_at is set.
